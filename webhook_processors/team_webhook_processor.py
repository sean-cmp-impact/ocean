...
from gitguardian.overrides import GitGuardianTeamConfig
...
class TeamWebhookProcessor(BaseGitGuardianWebhookProcessor):
    ...
    async def handle_event(
        ...
        config = cast(GitGuardianTeamConfig, resource_config)
